...
-- Gắn sự kiện chọn seed sau khi dropdown đã có giá trị
if seedDropdown then
    ...
    refreshSeedDropdown() -- Gọi lần đầu để điền giá trị
else
